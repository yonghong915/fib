...
import com.fib.msgconverter.commgateway.channel.http.config.HTTPServerChannelConfigParser;
import com.fib.msgconverter.commgateway.channel.http.config.database.HTTPServerChannelConfigLoader;
...
public class HTTPServerChannel extends Channel {
	...
	public void loadConfig(InputStream in) {
		if (CommGateway.isConfigDBSupport()) {
			HTTPServerChannelConfigLoader loader = new HTTPServerChannelConfigLoader();
	...
	private class CustomerHttpServerConnection extends
