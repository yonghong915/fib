...
public class LongConnectorHeartbeatRelationDAO extends AbstractDAO {
	...
	public LongConnectorHeartbeatRelationDAO(boolean inTransaction, Connection conn) {
		super(inTransaction, conn);
	}

	public int insert(LongConnectorHeartbeatRelation longConnectorHeartbeatRelation) {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		if (longConnectorHeartbeatRelation == null) {
			throw new IllegalArgumentException("longConnectorHeartbeatRelation is NULL!");
		}
		if (longConnectorHeartbeatRelation.getLongConnectorId() != null
			...
			throw new IllegalArgumentException(
					"longConnectorId too short" + longConnectorHeartbeatRelation.getLongConnectorId());
		}
		if (longConnectorHeartbeatRelation.getLongConnectorId() != null
				&& longConnectorHeartbeatRelation.getLongConnectorId().length() > 10) {
			throw new IllegalArgumentException(
					"longConnectorId too long" + longConnectorHeartbeatRelation.getLongConnectorId());
		}
		if (longConnectorHeartbeatRelation.getHeartbeatId() != null
				&& longConnectorHeartbeatRelation.getHeartbeatId().length() < 10) {
			throw new IllegalArgumentException(
					"heartbeatId too short" + longConnectorHeartbeatRelation.getHeartbeatId());
		}
		if (longConnectorHeartbeatRelation.getHeartbeatId() != null
				&& longConnectorHeartbeatRelation.getHeartbeatId().length() > 10) {
			throw new IllegalArgumentException(
					"heartbeatId too long" + longConnectorHeartbeatRelation.getHeartbeatId());
		}
		...
		try {
			...
			statment.setString(1, longConnectorHeartbeatRelation.getLongConnectorId());
			statment.setString(2, longConnectorHeartbeatRelation.getHeartbeatId());
			...
			if (DAOConfiguration.DEBUG) {
				...
				debug("LongConnectorHeartbeatRelationDAO.insert() spend " + (endTime - startTime) + "ms. retFlag = "
						+ retFlag + " SQL:" + sql + "; parameters : long_connector_id = \""
						+ longConnectorHeartbeatRelation.getLongConnectorId() + "\",heartbeat_id = \""
	...
	public int[] insertBatch(List<LongConnectorHeartbeatRelation> longConnectorHeartbeatRelationList) {
		// 获得连接对象
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		...
		if (longConnectorHeartbeatRelationList == null) {
			throw new IllegalArgumentException("longConnectorHeartbeatRelationList is NULL!");
		}
		...
		try {
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.insertBatch() spend " + (endTime - startTime)
	...
	public int update(LongConnectorHeartbeatRelation longConnectorHeartbeatRelation) {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		try {
			...
			statment.setString(1, longConnectorHeartbeatRelation.getLongConnectorId());
			statment.setString(2, longConnectorHeartbeatRelation.getHeartbeatId());
			statment.setString(3, longConnectorHeartbeatRelation.getLongConnectorId());
			statment.setString(4, longConnectorHeartbeatRelation.getHeartbeatId());
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.update() spend " + (endTime - startTime) + "ms. retFlag = "
						+ retFlag + " SQL:" + sql + "; parameters : long_connector_id = \""
						+ longConnectorHeartbeatRelation.getLongConnectorId() + "\",heartbeat_id = \""
						+ longConnectorHeartbeatRelation.getHeartbeatId() + "\" ");
			}
	...
	public int dynamicUpdate(Map<String,String> primaryKey, Map<String,Object> updateFields) {
		...
		try {
			...
			if (DAOConfiguration.DEBUG) {
				...
				sbDebug.append("LongConnectorHeartbeatRelationDAO.dynamicUpdate() spend " + (endTime - startTime)
	...
	public int deleteByPK(String longConnectorId, String heartbeatId) {
		...
		if (heartbeatId != null && heartbeatId.length() < 10) {
			throw new IllegalArgumentException("heartbeatId too short" + heartbeatId);
		}
		if (heartbeatId != null && heartbeatId.length() > 10) {
			throw new IllegalArgumentException("heartbeatId too long" + heartbeatId);
		}
		...
		try {
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.deleteByPK() spend " + (endTime - startTime) + "ms. retFlag = "
						+ retFlag + " SQL:" + sql + "; parameters : long_connector_id = \"" + longConnectorId
	...
	public LongConnectorHeartbeatRelation selectByPK(String longConnectorId, String heartbeatId) {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		try {
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.selectByPK() spend " + (endTime - startTime) + "ms. SQL:" + sql
						+ "; parameters : long_connector_id = \"" + longConnectorId + "\",heartbeat_id = \""
						+ heartbeatId + "\" ");
			}
			if (resultSet.next()) {
	...
	public List<LongConnectorHeartbeatRelation> findAll() {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		ResultSet resultSet = null;
		LongConnectorHeartbeatRelation returnDTO = null;
		List<LongConnectorHeartbeatRelation> list = new ArrayList<>();
		...
		try {
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.findAll() spend " + (endTime - startTime) + "ms. SQL:" + sql
						+ "; ");
			}
	...
	public List<LongConnectorHeartbeatRelation> findAll(int pageNum, int pageLength) {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		try {
			...
			if ("oracle".equalsIgnoreCase(DAOConfiguration.getDATABASE_TYPE())) {
				sql = "select * from(select A.*,ROWNUM RN from ( select * from long_connector_heartbeat_relation ) A where rownum <= "
						+ endNum + " ) where RN >=" + startNum + " order by long_connector_id,heartbeat_id";
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.findAll()(pageNum:" + pageNum + ",row count " + pageLength
	...
	public List<LongConnectorHeartbeatRelation> findByWhere(String where) {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		try {
			String sql = "select * from long_connector_heartbeat_relation where " + where
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.findByWhere()() spend " + (endTime - startTime) + "ms. SQL:"
						+ sql + "; parameter : " + where);
			}
			while (resultSet.next()) {
				returnDTO = new LongConnectorHeartbeatRelation();
	...
	public List<LongConnectorHeartbeatRelation> findByWhere(String where, int pageNum, int pageLength) {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		try {
			...
			if ("mysql".equalsIgnoreCase(DAOConfiguration.getDATABASE_TYPE())) {
				sql = "select * from long_connector_heartbeat_relation where " + where
						+ " order by long_connector_id,heartbeat_id limit " + startNum + "," + pageLength;
				...
				sql = "select * from ( select Top " + startNum + " * from (select Top " + endNum
						+ " * from long_connector_heartbeat_relation					 where " + where
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.findByWhere()(pageNum:" + pageNum + ",row count " + pageLength
	...
	public long getTotalRecords() {
		...
		try {
			...
			if (DAOConfiguration.DEBUG) {
				endTime = System.currentTimeMillis();
				debug("LongConnectorHeartbeatRelationDAO.getTotalRecords() spend " + (endTime - startTime) + "ms. SQL:"
						+ sql + "; ");
			}
	...
	public long getTotalRecordsByWhere(String where) {
		...
		try {
			String sql = "select  count(*) from long_connector_heartbeat_relation where " + where;
			statment = conn.prepareStatement(sql);
			long startTime = 0, endTime = 0;
			if (DAOConfiguration.DEBUG) {
				startTime = System.currentTimeMillis();
	...
	public List<LongConnectorHeartbeatRelation> getAllHeartbeat4LongConnector(String longConnectorId) {
		Connection conn = getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		try {
			...
			if (DAOConfiguration.DEBUG) {
				...
				debug("LongConnectorHeartbeatRelationDAO.getAllHeartbeat4LongConnector() spend "
						+ (_endTime - _startTime) + "ms. SQL:" + sql + "; parameter : longConnectorId = "
						+ longConnectorId);
			}
