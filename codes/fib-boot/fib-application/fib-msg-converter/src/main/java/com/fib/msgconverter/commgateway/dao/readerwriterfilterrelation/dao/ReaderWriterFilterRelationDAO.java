...
public class ReaderWriterFilterRelationDAO extends AbstractDAO {
	...
	public List<ReaderWriterFilterRelation> findAll ( )  {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		ResultSet resultSet = null;
		ReaderWriterFilterRelation returnDTO = null;
		List<ReaderWriterFilterRelation> list = new ArrayList<>();
	...
	public List<ReaderWriterFilterRelation> findAll (int pageNum, int pageLength)  {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
	...
	public List<ReaderWriterFilterRelation> findByWhere (String where) {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
	...
	public List<ReaderWriterFilterRelation> findByWhere (String where, int pageNum, int pageLength)  {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
	...
	public List<ReaderWriterFilterRelation> getAllFilter4ReaderOrWriter(String readerWriterId ) {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
