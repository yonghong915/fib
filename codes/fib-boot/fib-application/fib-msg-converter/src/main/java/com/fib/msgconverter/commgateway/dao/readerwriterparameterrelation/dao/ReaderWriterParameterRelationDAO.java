...
public class ReaderWriterParameterRelationDAO extends AbstractDAO {
	...
	public List<ReaderWriterParameterRelation> findAll ( )  {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
		...
		ResultSet resultSet = null;
		ReaderWriterParameterRelation returnDTO = null;
		List<ReaderWriterParameterRelation> list = new ArrayList<>();
	...
	public List<ReaderWriterParameterRelation> findAll (int pageNum, int pageLength)  {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
	...
	public List<ReaderWriterParameterRelation> findByWhere (String where) {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
	...
	public List<ReaderWriterParameterRelation> findByWhere (String where, int pageNum, int pageLength)  {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
	...
	public List<ReaderWriterParameterRelation> getAllParameter4ReaderOrWriter(String readerWriterId ) {
		Connection conn = this.getConnection();
		if (null == conn) {
			throw new RuntimeException("Connection is NULL!");
		}
