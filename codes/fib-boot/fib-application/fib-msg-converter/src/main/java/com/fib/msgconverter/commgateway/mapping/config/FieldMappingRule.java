...
public class FieldMappingRule {
	...
	public static String getMappingTypeText(int mappingType) {
		...
		case SCRIPT:
			return "script";
		default:
			// throw new IllegalArgumentException("Unkown Mapping Type["
			// + mappingType + "]!");
	 ...
	 * 值转换规则
	 */
	private Map translateRules = null;
	...
	public Map getTranslateRules() {
		return translateRules;
	}

	public void setTranslateRules(Map translateRules) {
