...
public class Message implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4369559222547989438L;
	/***/
	...
	/** 报文类型，默认common */
	private ConstantMB.MessageType type;
	...
	public Message() {
		type = ConstantMB.MessageType.COMMON;
	...
	public ConstantMB.MessageType getType() {
		return type;
	}

	public void setType(ConstantMB.MessageType i) {
		type = i;
	}
	...
	public boolean equalTo(Message message) {
		label0: {
			...
			if (null != xpath && null != message.getXpath() && !xpath.equalsIgnoreCase(message.getXpath()))
				return false;
			if (ConstantMB.MessageType.TAG == message.getType() || ConstantMB.MessageType.SWIFT == message.getType()) {
