...
//import com.fib.commons.security.support.Test;
//
...
//		boolean existsFlag = false;//redisUtil.hasKey(nonceKey);
//		if (existsFlag) {// 确保接口只能被调用一次，可以很好的解决重放攻击问题
//			// 请求重复
//			logger.info("-----------请求重复-------------");
//			return;
//		} else {
//			//redisUtil.set(nonceKey, nonce + timeStamp, signMaxTime);
//		}
//		Test t= Test.builder().data("aa").build();
//		logger.info(t.getData());
//		logger.info("---------------返回解析结束----------------------");
//	}
//
