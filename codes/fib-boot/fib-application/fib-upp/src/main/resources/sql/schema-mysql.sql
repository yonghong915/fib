...
CREATE TABLE beps_message_pack_rule  (
  pk_id BIGINT(20) NOT NULL COMMENT '主键编码',
  message_type VARCHAR(20)  NOT NULL COMMENT '交流事件编号',
  transaction_type VARCHAR(20)  NOT NULL COMMENT '交流事件类型',
  send_clearing_bank VARCHAR(20)  COMMENT '上一级交流事件号',
  receive_clearing_bank VARCHAR(20)  NOT NULL COMMENT '报文状态',
  return_limited VARCHAR(20)  NOT NULL DEFAULT '-1' COMMENT '发起机构',
  original_message_id VARCHAR(20)  NOT NULL DEFAULT '-1' COMMENT '接收机构',
  batch_id TIMESTAMP NOT NULL COMMENT '录入日期',
  del_flag SMALLINT DEFAULT 0 COMMENT '删除标志',
  create_by BIGINT(20)  DEFAULT 0 COMMENT '创建人',
  create_dt TIMESTAMP  DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  update_by BIGINT(0)  DEFAULT 0 COMMENT '更新人',
