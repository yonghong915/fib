package com.fib.autoconfigure.disruptor.config;
...
public class Ini implements Map<String, Ini.Section> {
	...
	private static final Logger log = LoggerFactory.getLogger(Ini.class);
	 ...
	 *
	 * @param defaults the default sections and/or key-value pairs to copy into the
	 *                 new instance.
	 */
	 ...
	 * sections, but the sections themselves are all empty, {@code false} otherwise.
	 *
	...
	/**
	 * Returns the names of all sections managed by this {@code Ini} instance or an
	 * empty collection if there are no sections.
	 *
	 * @return the names of all sections managed by this {@code Ini} instance or an
	 *         empty collection if there are no sections.
	 */
	...
	/**
	 * Returns the {@link Section} with the given name or {@code null} if no section
	 * with that name exists.
	 *
	 * @param sectionName the name of the section to retrieve.
	 * @return the {@link Section} with the given name or {@code null} if no section
	 *         with that name exists.
	 */
	...
	/**
	 * Ensures a section with the specified name exists, adding a new one if it does
	 * not yet exist.
	 *
	 * @param sectionName the name of the section to ensure existence
	 * @return the section created if it did not yet exist, or the existing Section
	...
	/**
	 * Removes the section with the specified name and returns it, or {@code null}
	 * if the section did not exist.
	 *
	 * @param sectionName the name of the section to remove.
	 * @return the section with the specified name or {@code null} if the section
	 *         did not exist.
	 */
	...
	/**
	 * Sets a name/value pair for the section with the given {@code sectionName}. If
	 * the section does not yet exist, it will be created. If the
	 * {@code sectionName} is null or empty, the name/value pair will be placed in
	 * the default (unnamed, empty string) section.
	 *
	...
	/**
	 * Returns the value of the specified section property, or {@code null} if the
	 * section or property do not exist.
	 *
	 * @param sectionName  the name of the section to retrieve to acquire the
	 *                     property value
	 * @param propertyName the name of the section property for which to return the
	 *                     value
	 * @return the value of the specified section property, or {@code null} if the
	 *         section or property do not exist.
	 */
	 ...
	 * @param sectionName  the name of the section to add the name/value pair
	 * @param propertyName the name of the property to add
	 * @param defaultValue the default value to return if the section or property do
	 *                     not exist.
	...
	/**
	 * Loads the INI-formatted text backed by the given Scanner. This implementation
	 * will close the scanner after it has finished loading.
	 *
	...
	public void load(Scanner scanner) {
		...
		while (scanner.hasNextLine()) {
			...
			if (newSectionName != null) {
				// found a new section - convert the currently buffered one into a Section
				// object
	...
	public static class Section implements Map<String, String> {
		...
		// Protected to access in a test case - NOT considered part of Shiro's public
		// API
