package com.fib.autoconfigure.disruptor.util;
...
public final class WaitStrategys {
	private WaitStrategys() {
	}
	 ...
	 */
	public static final WaitStrategy BUSYSPIN_WAIT = new BusySpinWaitStrategy();
}
