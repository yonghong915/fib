package com.fib.autoconfigure.msgconverter.message.metadata;
...
public class Field {
	...
	private Map<String, String> macFldDataCache;
	...
	public Map<String, String> getMacFldDataCache() {
		return macFldDataCache;
	}

	public void setMacFldDataCache(Map<String, String> map) {
		macFldDataCache = map;
	}
	...
	public boolean equalTo(Field field) {
		label0: {
			label1: {
				...
				if ((null == dataCharset) ^ (null == field.getDataCharset()))
					return false;
				if (null != dataCharset && null != field.getDataCharset() && !dataCharset.equalsIgnoreCase(field.getDataCharset()))
					return false;
				...
				if (2001 == fieldType || 2003 == fieldType || 2009 == fieldType || 2011 == fieldType) {
					...
					if (2011 == fieldType) {
						if ((null == tabPrefix) ^ (null == field.getTabPrefix()))
							return false;
						if (null != tabPrefix && null != field.getTabPrefix() && !Arrays.equals(tabPrefix, field.getTabPrefix()))
							return false;
						if ((null == tabSuffix) ^ (null == field.getTabSuffix()))
							return false;
						if (null != tabSuffix && null != field.getTabSuffix() && !Arrays.equals(tabSuffix, field.getTabSuffix()))
							return false;
				...
				if (2002 == fieldType || 2003 == fieldType || 2004 == fieldType || 2011 == fieldType || 2008 == fieldType || 2009 == fieldType) {
					...
					if ((null == referenceId) ^ (null == field.getReferenceId()))
						return false;
					if (null != referenceId && null != field.getReferenceId() && !referenceId.equalsIgnoreCase(field.getReferenceId()))
						return false;
					if ((null == referenceType) ^ (null == field.getReferenceType()))
						return false;
					if (null != referenceType && null != field.getReferenceType() && !referenceType.equalsIgnoreCase(field.getReferenceType()))
						return false;
					...
					if (2004 == fieldType) {
						...
						if ((null == rowXpath) ^ (null == field.getRowXpath()))
							return false;
						if (null != rowXpath && null != field.getRowXpath() && !rowXpath.equalsIgnoreCase(field.getRowXpath()))
							return false;
					}
					break label0;
				}
				...
				if ((null == lengthScript) ^ (null == field.getLengthScript()))
					return false;
				if (null != lengthScript && null != field.getLengthScript() && !lengthScript.equalsIgnoreCase(field.getLengthScript()))
					return false;
				...
				if ((null == startFieldName) ^ (null == field.getStartFieldName()))
					return false;
				if (null != startFieldName && null != field.getStartFieldName() && !startFieldName.equalsIgnoreCase(field.getStartFieldName()))
					return false;
				if ((null == endFieldName) ^ (null == field.getEndFieldName()))
					return false;
				if (null != endFieldName && null != field.getEndFieldName() && !endFieldName.equalsIgnoreCase(field.getEndFieldName()))
					return false;
				...
				if (null == macFldDataCache || null == field.getMacFldDataCache())
					break label1;
				Iterator<String> iterator = field.getMacFldDataCache().values().iterator();
				String s = null;
				do {
					if (!iterator.hasNext())
						break label1;
			...
			if (2005 == fieldType) {
				if ((null == tableName) ^ (null == field.getTableName()))
					return false;
				if (null != tableName && null != field.getTableName() && !tableName.equalsIgnoreCase(field.getTableName()))
					return false;
			}
		...
		label2: {
			...
			if (null == subFields || null == field.getSubFields())
				break label2;
			Iterator<Field> iterator1 = subFields.values().iterator();
			Field field1 = null;
			do {
		...
		label3: {
			...
			if (null == valueRange || null == field.getValueRange())
				break label3;
			Iterator<ValueRange> iterator2 = field.getValueRange().values().iterator();
			ValueRange valuerange = null;
			do {
				if (!iterator2.hasNext())
					break label3;
				valuerange = iterator2.next();
			} while (valuerange.equalsTo(valueRange.get(valuerange.getValue())));
			return false;
		}
		if ((null == prePackEvent) ^ (null == field.getPrePackEvent()))
			return false;
		if (null != prePackEvent && null != field.getPrePackEvent() && !prePackEvent.equalsIgnoreCase(field.getPrePackEvent()))
			return false;
		if ((null == postPackEvent) ^ (null == field.getPostPackEvent()))
			return false;
		if (null != postPackEvent && null != field.getPostPackEvent() && !postPackEvent.equalsIgnoreCase(field.getPostPackEvent()))
			return false;
		if ((null == preParseEvent) ^ (null == field.getPreParseEvent()))
			return false;
		if (null != preParseEvent && null != field.getPreParseEvent() && !preParseEvent.equalsIgnoreCase(field.getPreParseEvent()))
			return false;
		if ((null == postParseEvent) ^ (null == field.getPostParseEvent()))
			return false;
		if (null != postParseEvent && null != field.getPostParseEvent() && !postParseEvent.equalsIgnoreCase(field.getPostParseEvent()))
			return false;
		if ((null == preRowPackEvent) ^ (null == field.getPreRowPackEvent()))
			return false;
		if (null != preRowPackEvent && null != field.getPreRowPackEvent() && !preRowPackEvent.equalsIgnoreCase(field.getPreRowPackEvent()))
			return false;
		if ((null == postRowPackEvent) ^ (null == field.getPostRowPackEvent()))
			return false;
		if (null != postRowPackEvent && null != field.getPostRowPackEvent() && !postRowPackEvent.equalsIgnoreCase(field.getPostRowPackEvent()))
			return false;
		if ((null == preRowParseEvent) ^ (null == field.getPreRowParseEvent()))
			return false;
		if (null != preRowParseEvent && null != field.getPreRowParseEvent() && !preRowParseEvent.equalsIgnoreCase(field.getPreRowParseEvent()))
			return false;
		if ((null == postRowParseEvent) ^ (null == field.getPostRowParseEvent()))
			return false;
		if (null != postRowParseEvent && null != field.getPostRowParseEvent() && !postRowParseEvent.equalsIgnoreCase(field.getPostRowParseEvent()))
			return false;
		if ((null == expression) ^ (null == field.getExpression()))
			return false;
		return null == expression || null == field.getExpression() || expression.equalsIgnoreCase(field.getExpression());
	}
