...
public class ConfigUtils {
	 ...
	 * <ul>
	 * <li>Special value <code><strong>default</strong></code>, means the location
	 * for default extensions.
	 * <li>Special symbol<code><strong>-</strong></code>, means remove.
	 * <code>-foo1</code> will remove default extension 'foo'; <code>-default</code>
	 ...
	 *                       {@link IllegalStateException} when found multi file on
	 *                       the class path.
	 ...
	 *         </ul>
	 * @throws IllegalStateException not allow multi-file, but multi-file exist on
	 *                               class path.
	 */
	public static Properties loadProperties(String fileName, boolean allowMultiFile, boolean optional) {
		...
		if (checkFileNameExist(fileName)) {
			try {
				...
				logger.warn("Failed to load " + fileName + " file from " + fileName + "(ignore this file): "
						+ e.getMessage(), e);
			}
			return properties;
		}
		...
		for (java.net.URL url : list) {
			try {
				...
				logger.warn("Fail to load " + fileName + " file from " + url + "(ignore this file): " + e.getMessage(),
						e);
			}
		}
