...
import com.fib.core.common.util.CollectionUtils;
import com.fib.core.common.util.Constants;
import com.fib.core.common.util.NetUtils;
import com.fib.core.common.util.StringUtils;

public final class URL implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2885244290851644078L;
	...
	public URL(String protocol, String host, int port, String[] pairs) { // varargs ... confilict with the following
																			// path argument, use array instead.
	 ...
	 * socket's address or to search in a map which use address as its key.
	 *
