package com.fib.gateway.channel.config.base;
...
public class ConnectionConfig {
	...
	public static String getTypeText(int type) {
		...
		default:
			throw new RuntimeException(MultiLanguageResourceBundle.getInstance()
					.getString("ConnectionConfig.getTypeByText.connectionType.unsupport", new String[] { type + "" }));
		}
	}
	...
	public static int getTypeByText(String typeText) {
		if (CONN_TYP_SERVER_TXT.equalsIgnoreCase(typeText)) {
			...
			// + "]!");
			throw new RuntimeException(MultiLanguageResourceBundle.getInstance()
					.getString("ConnectionConfig.getTypeByText.connectionType.unsupport", new String[] { typeText }));
		}
	}
	...
	public static int getDirectionByText(String directionText) {
		if (COMM_DIRECTION_SEND_TXT.equalsIgnoreCase(directionText)) {
			...
			// + directionText + "]!");
			throw new RuntimeException(MultiLanguageResourceBundle.getInstance()
					.getString("ConnectionConfig.directionType.unsupport", new String[] { directionText }));
		}
	}
	...
	public static String getDirectionText(int direction) {
		...
		default:
			...
			// + "]!");
			throw new RuntimeException(MultiLanguageResourceBundle.getInstance()
					.getString("ConnectionConfig.directionType.unsupport", new String[] { "" + direction }));
		}
	}
