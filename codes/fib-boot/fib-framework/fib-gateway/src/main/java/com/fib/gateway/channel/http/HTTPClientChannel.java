...
public abstract class HTTPClientChannel extends Channel {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.giantstone.commgateway.channel.Channel#closeSource(java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.giantstone.commgateway.channel.Channel#loadConfig()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.giantstone.commgateway.channel.Channel#sendRequestMessage(byte[],
	 * int)
	 */
...
//					.getString("HTTPClientChannel.sendRequestMessage.createParameter.failed"), e);
	 ...
	 * @return
	 */
	protected abstract Map createParamters(byte[] requestMessage);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.giantstone.commgateway.channel.Channel#sendResponseMessage(byte[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.giantstone.commgateway.channel.Channel#shutdown()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.giantstone.commgateway.channel.Channel#start()
	 */
	public void start() {
		// 初始化线程组
...
//				}
			...
			//	HttpClient client = HttpClient.newHttpClient();//new HttpClient(httpClientParams, new SimpleHttpConnectionManager(true));
