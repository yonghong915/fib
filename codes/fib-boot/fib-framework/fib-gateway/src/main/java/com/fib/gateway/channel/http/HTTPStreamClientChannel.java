...
import com.fib.gateway.channel.http.config.HTTPClientChannelConfig;
import com.fib.gateway.channel.http.config.HTTPClientChannelConfigParser;
...
public class HTTPStreamClientChannel extends Channel {
    ...
    public void sendRequestMessage(byte[] var1, boolean var2, int var3) {
        ...
        if(var4 >= this.config.getMaxHandlerNumber()) {
            String var7 = MultiLanguageResourceBundle.getInstance().getString("HTTPClientChannel.sendRequestMessage.noHandler", new String[]{"" + var4});
    ...
    public void sendResponseMessage(byte[] var1) {
        throw new RuntimeException(MultiLanguageResourceBundle.getInstance().getString("HTTPClientChannel.sendResponseMessage.error", new String[]{this.mainConfig.getId()}));
    }
...
//                //HTTPStreamClientChannel.this.logger.error(MultiLanguageResourceBundle.getInstance().getString("HTTPClientHandler.run.createMethod.error", new String[]{CodeUtil.Bytes2FormattedText(this.requestMessage)}));
...
//                }
//                
//                HttpClient var18 =HttpClient.newHttpClient();// new HttpClient(var16, new SimpleHttpConnectionManager(true));
//                if(null != HTTPStreamClientChannel.this.logger && HTTPStreamClientChannel.this.logger.isInfoEnabled() && null != this.requestMessage) {
//                    Object var4 = null;
//                    byte[] var19;
//                    if(CommGateway.isShieldSensitiveFields()) {
//                        var19 = A.A(new String(this.requestMessage), CommGateway.getSensitiveFields(), CommGateway.getSensitiveReplaceChar()).getBytes();
//                    } else {
//                        var19 = this.requestMessage;
//                    }
//
//                   // HTTPStreamClientChannel.this.logger.info(MultiLanguageResourceBundle.getInstance().getString("SocketClientChannel.handleKey.sendRequest.success", new String[]{CodeUtil.Bytes2FormattedText(var19)}));
//                }
//
...
////                        byte[] var21;
////                        if(CommGateway.isShieldSensitiveFields()) {
////                            var21 = A.A(new String(var5), CommGateway.getSensitiveFields(), CommGateway.getSensitiveReplaceChar()).getBytes();
////                        } else {
////                            var21 = var5;
////                        }
////
////                      //  HTTPStreamClientChannel.this.logger.info(MultiLanguageResourceBundle.getInstance().getString("SocketClientChannel.handleKey.receiveResponse.success", new String[]{CodeUtil.Bytes2FormattedText(var21)}));
////                    }
//
...
//
//                if(CommGateway.isExceptionMonitorSupport()) {
//                    HTTPStreamClientChannel.this.onResponseMessageReceiveException(this, this.requestMessage, new RuntimeException(var1.getStatusLine().toString()), this.channelId, this.dumpIp, this.dumpPort);
//                } else {
//                    HTTPStreamClientChannel.this.onResponseMessageReceiveException(this, this.requestMessage, new RuntimeException(var1.getStatusLine().toString()));
//                }
//
//                return;
//            } catch (ConnectException var12) {
//               // HTTPStreamClientChannel.this.logger.error(MultiLanguageResourceBundle.getInstance().getString("HTTPClientHandler.run.connect.error"), var12);
//                if(CommGateway.isExceptionMonitorSupport()) {
//                    HTTPStreamClientChannel.this.onConnectException(this, this.requestMessage, var12, this.channelId, this.dumpIp, this.dumpPort);
//                } else {
...
//                //HTTPStreamClientChannel.this.logger.error(MultiLanguageResourceBundle.getInstance().getString("HTTPClientHandler.run.communicate.error"), var13);
//                if(CommGateway.isExceptionMonitorSupport()) {
//                    HTTPStreamClientChannel.this.onRequestMessageSendException(this, this.requestMessage, var13, this.channelId, this.dumpIp, this.dumpPort);
//                } else {
