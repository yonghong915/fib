...
public abstract class AbstractNioReader implements NioReader, Cloneable {
	 ...
	 * 报文缓存
	 */
	protected com.fib.gateway.message.util.ByteBuffer messageBuffer;
	...
	public AbstractNioReader() {
		messageBuffer = new com.fib.gateway.message.util.ByteBuffer(
				INIT_BUFFER_SIZE);
	}
	 ...
	 * 
	 * @see
	 * com.giantstone.commgateway.channel.nio.NioReader#read(java.nio.channels
	...
	public Object clone() {
		...
		o.messageBuffer = new com.fib.gateway.message.util.ByteBuffer(
				INIT_BUFFER_SIZE);
		o.onceRead = 0;
		o.message = null;
		return o;
