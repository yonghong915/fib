...
public final class EnumConstants {
	...
	public enum MsgTypeList {
		TAG_LIST(EnumConstants.MsgType.TAG.getCode(), Lists.newArrayList(EnumConstants.FieldType.TABLE.getCode(),
				EnumConstants.FieldType.TABLE_ROW_NUM_FIELD.getCode(), EnumConstants.FieldType.FIXED_FIELD.getCode(),
				EnumConstants.FieldType.COMBINE_FIELD.getCode(), EnumConstants.FieldType.REFERENCE_FIELD.getCode()));
		...
		MsgTypeList(int code, List<Integer> arrayList) {
			this.code = code;
