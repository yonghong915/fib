...
public class SessionManager {
	...
	private static Logger exceptionManagerLogger = LoggerFactory.getLogger("exception-manager");
	...
	public static void start() {
		if (null == sessionConfig) {
			...
			throw new RuntimeException(
					MultiLanguageResourceBundle.getInstance().getString("SessionManager.sessionConfig.null"));
		}
		if (!run) {
	...
	public static void stop() {
		...
		while (iterator.hasNext()) {
			...
			session.setErrorMessage(
					MultiLanguageResourceBundle.getInstance().getString("SessionManager.gateway.closed"));
			...
			while (run) {
				...
				synchronized (sessions) {
					...
					while (iterator.hasNext()) {
						...
						if (System.currentTimeMillis() - session.getLastAliveTime() >= session.getTimeout()) {
...
//				errorMessage = ExceptionUtil.getExceptionDetail(session.getException());
//			} else {
//				errorMessage = errorMessage + ":" + ExceptionUtil.getExceptionDetail(session.getException());
//			}
//		}
//
...
//				// e);
//				logger.error(MultiLanguageResourceBundle.getInstance().getString("SessionManager.recordSession.failed"),
//						e);
//			}
//		} finally {
//			if (null != conn) {
