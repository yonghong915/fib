...
public class BEPS_121_bean extends MessageBean{
	...
	//报文体
	private com.giantstone.cnaps2.messagebean.recv.req.BEPS_121_Out bEPS_121_Out = new com.giantstone.cnaps2.messagebean.recv.req.BEPS_121_Out();

	public com.giantstone.cnaps2.messagebean.recv.req.BEPS_121_Out getBEPS_121_Out(){
		return bEPS_121_Out;
	}

	public void setBEPS_121_Out(com.giantstone.cnaps2.messagebean.recv.req.BEPS_121_Out bEPS_121_Out){
	...
	public void setAttribute(String name,Object value){
		if("MsgHeader".equals(name)){
			...
			this.setBEPS_121_Out((com.giantstone.cnaps2.messagebean.recv.req.BEPS_121_Out)value);
		}else if("checkEscortFlag".equals(name)){
	...
	public String toString(boolean isWrap,boolean isTable){
		...
		if( 0 == buf.length()){
			...
			if ( isTable ){
				...
				buf.insert(0,"<b c=\"com.giantstone.cnaps2.messagebean.recv.req.BEPS_121_bean\">");
			}
			buf.append("</b>");
			if( !isWrap ){
