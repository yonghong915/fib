...
public class CCMS_990_bean extends MessageBean{
	...
	//报文头
	private com.fib.upp.cnaps2.messagebean.recv.req.MsgHeader msgHeader = new com.fib.upp.cnaps2.messagebean.recv.req.MsgHeader();

	public com.fib.upp.cnaps2.messagebean.recv.req.MsgHeader getMsgHeader(){
		return msgHeader;
	}

	public void setMsgHeader(com.fib.upp.cnaps2.messagebean.recv.req.MsgHeader msgHeader){
		this.msgHeader = msgHeader;
	}

	//报文体
	private com.fib.upp.cnaps2.messagebean.send.req.CCMS_990_Out cCMS_990_Out = new com.fib.upp.cnaps2.messagebean.send.req.CCMS_990_Out();

	public com.fib.upp.cnaps2.messagebean.send.req.CCMS_990_Out getCCMS_990_Out(){
		return cCMS_990_Out;
	}

	public void setCCMS_990_Out(com.fib.upp.cnaps2.messagebean.send.req.CCMS_990_Out cCMS_990_Out){
	...
	public void setAttribute(String name,Object value){
		if("MsgHeader".equals(name)){
			this.setMsgHeader((com.fib.upp.cnaps2.messagebean.recv.req.MsgHeader)value);
		}else if("CCMS_990_Out".equals(name)){
			this.setCCMS_990_Out((com.fib.upp.cnaps2.messagebean.send.req.CCMS_990_Out)value);
		}
	}
	...
	public String toString(boolean isWrap,boolean isTable){
		...
		if( 0 == buf.length()){
			...
			if ( isTable ){
				...
				buf.insert(0,"<b c=\"com.fib.upp.cnaps2.messagebean.send.req.CCMS_990_bean\">");
			}
			buf.append("</b>");
			if( !isWrap ){
