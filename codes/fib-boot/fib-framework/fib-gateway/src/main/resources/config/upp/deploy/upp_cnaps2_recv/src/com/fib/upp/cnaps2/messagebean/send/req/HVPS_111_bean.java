...
public class HVPS_111_bean extends MessageBean{
	...
	//报文体
	private com.fib.upp.cnaps2.messagebean.send.req.HVPS_111_Out hVPS_111_Out = new com.fib.upp.cnaps2.messagebean.send.req.HVPS_111_Out();

	public com.fib.upp.cnaps2.messagebean.send.req.HVPS_111_Out getHVPS_111_Out(){
		return hVPS_111_Out;
	}

	public void setHVPS_111_Out(com.fib.upp.cnaps2.messagebean.send.req.HVPS_111_Out hVPS_111_Out){
	...
	public void setAttribute(String name,Object value){
		if("MsgHeader".equals(name)){
			...
			this.setHVPS_111_Out((com.fib.upp.cnaps2.messagebean.send.req.HVPS_111_Out)value);
		}
	}
	...
	public String toString(boolean isWrap,boolean isTable){
		...
		if( 0 == buf.length()){
			...
			if ( isTable ){
				...
				buf.insert(0,"<b c=\"com.fib.upp.cnaps2.messagebean.send.req.HVPS_111_bean\">");
			}
			buf.append("</b>");
			if( !isWrap ){
