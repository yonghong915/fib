...
public class NettyServer {
	...
	private void init() {
		...
		bootstrap.group(bossGroup, workerGroup).childOption(ChannelOption.SO_SNDBUF, 128 * 1024)
				.childOption(ChannelOption.SO_RCVBUF, 128 * 1024).childOption(ChannelOption.SO_KEEPALIVE, false)
